...
class Container_0dac7b952b extends _PHPStan_76800bfb5\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'analysedPaths' => ['/home/alfonso/projects/test-codex/src', '/home/alfonso/projects/test-codex/tests'],
			'composerAutoloaderProjectPaths' => ['/home/alfonso/projects/test-codex'],
			'analysedPathsFromConfig' => ['/home/alfonso/projects/test-codex/src', '/home/alfonso/projects/test-codex/tests'],
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, false, ['/home/alfonso/projects/test-codex']);
	}
	...
	public function createService027(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_0dac7b952b $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					['/home/alfonso/projects/test-codex/src', '/home/alfonso/projects/test-codex/tests'],
	...
	public function createService030(): PHPStan\Command\AnalyseApplication
	{
		return new PHPStan\Command\AnalyseApplication(
			...
			$this->getService('027'),
			$this->getService('024'),
			'/home/alfonso/projects/test-codex/var/phpstan/.memory_limit',
			50
		);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('086'), false);
	}
	...
	{
		return new PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension(false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('085'), false, false);
	}


	public function createService0299(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('085'), false, false);
	}


	public function createService0300(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('085'), false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('085'), false);
	}


	public function createService0305(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('085'), false);
	}


	public function createService0306(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('086'), false, false);
	}


	public function createService0307(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('086'), false, false);
	}


	public function createService0308(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('086'), false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('085'), false);
	}


	public function createService0312(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('085'), false);
	}


	public function createService0313(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('085'), false);
	}
	...
	public function createServiceContainer(): Container_0dac7b952b
	{
		return $this;
	}
