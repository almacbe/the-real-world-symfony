...
class Container_ca0acb3cf0 extends _PHPStan_71ced81c9\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.propertiesClassReflectionExtension' => ['083' => true, '087' => true, '0200' => true],
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0210' => true],
		'phpstan.rules.rule' => [
			'0290' => true,
			'0291' => true,
			'0292' => true,
	...
	protected $types = ['container' => '_PHPStan_71ced81c9\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_71ced81c9\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0102',
				'0103',
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['073', '083', '084', '087', '0200']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0167', '0169', '0271', '0277']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0210']],
	...
	public function createService042(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ca0acb3cf0 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/alfonso/projects/test-codex/var/phpstan/resultCaches',
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0100'), false);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0127'), $this->getService('0128'), true, false, false);
	}
	...
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(false, false);
	}


	public function createService0332(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('099'), false);
	}


	public function createService0333(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('099'), false);
	}


	public function createService0334(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('099'), false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('099'), false);
	}


	public function createService0337(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('099'), false);
	}


	public function createService0338(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('099'), false);
	}


	public function createService0339(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0100'), false, false);
	}


	public function createService0340(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0100'), false, false);
	}


	public function createService0341(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0100'), false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('099'), false);
	}


	public function createService0346(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('099'), false);
	}


	public function createService0347(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('099'), false);
	}


	public function createService0348(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('099'), false);
	}


	public function createService0349(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('099'), false);
	}
	...
	public function createServiceContainer(): Container_ca0acb3cf0
	{
		return $this;
	}
